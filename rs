...
wait(5)
local RAMAccount = loadstring(game:HttpGet'https://raw.githubusercontent.com/vn4medataweb/data/main/r')()
...
if MyAccount then
  ...
  while wait() do
    MyAccount:SetAlias(game.Players.LocalPlayer.Data.Level.Value.."-"..checkmeleecount()..checkgod()..checkcdk()..checkttk()..guong()..checksoulguitar()..checkttk())
    wait(120)
  end
end
